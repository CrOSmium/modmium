...
menu_reset() {
  ...
  options=("${G}Update Modmium${N}" "Change ChromeOS Version" "${B}Change Shell${N}" "${R}Change Source Repository${N}" "Swap Boot Priority" "${Y}Toggle Enrollment${N}" "Add Local Account" "Feature Toggles" "Exit")

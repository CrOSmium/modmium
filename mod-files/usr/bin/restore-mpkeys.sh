...
main(){
    ...
    echo -e "This script is a work in progress, it should return you to MPkeys and restore your firmware to normal if you lost your backup.\nhowever, this is very destructive and can brick your device."
    echo ""
